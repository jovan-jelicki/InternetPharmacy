...
VALUES (1, '2021-01-30', 3, 1,1);
INSERT INTO medication_reservation(id, pick_up_date, status, medication_quantity_id, patient_id)
VALUES (2, '2021-01-26', 3, 1,2);
...
insert into appointment (id, cost, examiner_id,  patient_id, period_end, period_start, pharmacy_id, report, therapy_id, type)
    values (1,2000,1,null, '2021-03-01 11:00:00', '2021-03-01 10:00:00', 0, null,null,0);